/**
 * Lightweight inline SVG icon set. Each icon inherits currentColor and
 * accepts standard SVG props. Keeps us free of an icon dependency while
 * giving the redesign a consistent visual language.
 */
